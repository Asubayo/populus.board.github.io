...
<script src="/web_suivi_terrains/public/js/maps/fondreau.js" charset="utf-8"></script>
...
<script type="text/javascript">
    ...
    function onShowSatelliteView(obj) {
        if($(obj).is(":checked")){
            $(".container")[0].style = "background-image: url('/web_suivi_terrains/public/images/satellite_global_view_fondreau.jpg'); background-size: cover;"
        }else{
            $(".container")[0].style = "";
        }
    }
            ...
            map: {
                ...
                afterInit : function($self, paper, areas, plots, options) {
                    ...
                    $(window).on('resize', function () {
                        ...
                        var im_height = $.mapael.maps['fondreau'].height;
                        var im_width = $.mapael.maps['fondreau'].width;
                        
                        var v_fact = viewportHeight / $.mapael.maps['fondreau'].height ;
                        var h_fact = viewportWidth / $.mapael.maps['fondreau'].width;
